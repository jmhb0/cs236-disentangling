...
def log_normal(x, m, v, device='cpu'):
    """
...
def log_normal_mixture(z, m, v):
    ...
    This implementation has implicitly assumed a uniform mixing coefficient, pu.
    because it takes the mean of the k gaussian probabilities, and not a weighted
    mean. 
    Args:
